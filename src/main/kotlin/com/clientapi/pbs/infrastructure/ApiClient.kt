package com.clientapi.pbs.infrastructure
...
open class ApiClient(val baseUrl: String, val client: Call.Factory = defaultClient) {
    companion object {
        ...
        const val BASE_URL_KEY: String = "com.clientapi.pbs.baseUrl"
        @Deprecated(
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
            if (apiKey["PBSAuthCookie"] != null) {
                if (apiKeyPrefix["PBSAuthCookie"] != null) {
                } else {
                }
            }
